...
public class DocumentVector {
    ...
    public DocumentVector(String field, float score) { // Ani
        docPerTermStat = new HashMap<>();
        this.field = field;
        this.docScore = score;
    }
    ...
    public DocumentVector getDocumentVector(int luceneDocId, IndexReader indexReader, float score) throws IOException {
