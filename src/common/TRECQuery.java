...
public class TRECQuery {
    ...
    public String       qlat;
    public String       qlng;
    public String       qClass; // class/type name based on TREC CS tags' clusters (used while breaking a query into sub-queries)
    public float        qClassWeight; // weight of qClass (e.g. if user U preferred a class "food" more then "food" class will get higher weight)

    public List<TermList>   topTerms;
    public int              nTopTerms;
    
    public String       composition; // Additional composed terms (word composition Doi KDERLM CIKM '16)
