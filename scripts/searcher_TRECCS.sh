...
W2VFilePath="/store/TCD/TREC_CS/Wor2vec/trunk/64K_BOW_analysed_vectors.bin.vec"
...
java -Xmx1g -cp $CLASSPATH:dist/WebData.jar:./lib/* searcher.WebDocSearcher_TRECCS $prop_name
